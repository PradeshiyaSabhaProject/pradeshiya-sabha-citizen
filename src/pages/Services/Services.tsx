...
const Services = () => {
  ...
  const servicesData = [
    {
      id: 'complaints',
      title: t('home.complaintTitle', 'Complaints'),
      desc: t('home.complaintDesc', 'Street lights, waste, or roads.'),
      icon: <ComplaintIcon />,
      onClick: () => navigate('/complaints')
    },
    {
      id: 'appointments',
      title: t('home.facilityTitle', 'Appointments & Reservations'),
      desc: t('home.facilityDesc', 'Schedule a meet with officials.'),
      icon: <CalendarIcon />,
      onClick: () => navigate('/appointments')
    },
    {
      id: 'letters',
      title: t('home.letterTitle', 'Letters'),
